...
public class PlaylistReader {
    ...
    public PlaylistReader(String songsFileName, String playlistsFileName)
        ...
        PlaylistWindow window = new PlaylistWindow(pc);
    } // end of constructor
    ...
    private Playlist[] readPlaylistFile(String playlistFileName)
        ...
        // 1.TODO: Instantiate a local array of playlist objects that willstore
        ...
        while (file.hasNextLine()
            ...
            if (tokens.length < 8) {
                throw new ParseException("Wrong number of values", 
                    tokens.length);
            }
                ...
                {
                    throw new DailyMixDataException("Not in bounds");
                }
        ...
        {
            throw new DailyMixDataException("Less than 3 playlists");
        }
    ...
    private ArrayQueue<Song> readQueueFile(String songFileName)
        ...
        while (file.hasNextLine()) 
        {
            ...
            if (tokens.length < 4) 
            {
                throw new ParseException("Less than 4 songs", tokens.length);
            }
